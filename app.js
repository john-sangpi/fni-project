...
function travel(sender_psid) {
  ...
  if (userFont == 'zawgyi') {
    ...
    response1 = { "text": "လူကြီးမင်း၏ သာယာလှပသော ပြည်တွင်း/ပ ခရီးစဥ်များ သွားလာရာတွင် မိမိကိုယ်တိုင် သော်လည်းကောင်း၊ တစ်စုံတစ်ယောက် ကြောင့် သော်လည်းကောင်း၊ ခရီးစဥ်အတွင်း စီးနင်းလိုက်ပါသော ယာဥ် နှင့် ဆက်စပ်သော မတော်တဆထိခိုက်မှု များ ပေါ် ပေါက်ခဲ့ပါက အထောက်အပံ့ ရရှိစေသော ခရီးသွားအာမခံ ဖြစ်ပါတယ်ရှင့်..." };
    response2 = {
      "attachment": {
        "type": "template",
        "payload": {
